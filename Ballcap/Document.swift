...
public protocol Documentable: Equatable {
    ...
    associatedtype Model = Void

    associatedtype CollectionKeys = Void

    var id: String { get }

    var path: String { get }

    var snapshot: DocumentSnapshot? { get set }
...
public extension Documentable where Model: Modelable {
...
public extension Documentable where Model: Modelable & Codable {
...
public class Document: Documentable {
    ...
    public convenience init() {
        self.init(documentReference: type(of: self).collectionReference.document())
    }
    ...
    public convenience init(id: String, collectionReference: CollectionReference? = nil) {
        self.init()
        self.documentReference =  collectionReference?.document(id) ?? type(of: self).collectionReference.document(id)
    }
...
//extension Document where Model: Modelable & Codable {
//
////    public init() {
////        self.data = Model()
...
//    }
//
//    public init?(id: String, from data: [String: Any], collectionReference: CollectionReference? = nil) {
//        self.init()
//        do {
//            self.data = try Firestore.Decoder().decode(Model.self, from: data)
//            self.createdAt = data["createdAt"] as? Timestamp ?? Timestamp(date: Date())
...
//public extension Documentable where Self: Initializeable, Model: Modelable & Codable {
//
//    required init() {
//        self.data = Model()
//        self.documentReference = Model.collectionReference.document()
...
//public extension Documentable where Self: Initializeable Model: Modelable & Documentable {
//
